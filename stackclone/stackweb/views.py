...
from stackweb.forms import RegistrationForm,LoginForm,QuestionForm,UserProfileForm
from django.views.generic import View,CreateView,FormView,TemplateView,ListView,UpdateView
from django.contrib.auth.models import User
from django.urls import reverse_lazy
from django.contrib.auth import authenticate,login,logout
from stackweb.models import Questions,Answers,UserProfile
    ...
    def post(self,request,*args,**kwargs):
        ...
        if form.is_valid():
            ...
            if usr:
                ...
                return redirect(request,"login.html",{"form":self.form_class})
